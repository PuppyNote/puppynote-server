...
include::{snippets}/community-post-like-toggle/http-request.adoc[]
include::{snippets}/community-post-like-toggle/path-parameters.adoc[]

==== HTTP Response

include::{snippets}/community-post-like-toggle/http-response.adoc[]
include::{snippets}/community-post-like-toggle/response-fields.adoc[]
