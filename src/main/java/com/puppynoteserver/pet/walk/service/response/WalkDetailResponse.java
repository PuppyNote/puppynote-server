...
public class WalkDetailResponse {
    ...
    private WalkDetailResponse(Long walkId, Long petId, LocalDateTime startTime, LocalDateTime endTime,
    ...
    public static WalkDetailResponse of(Walk walk, List<String> photoUrls) {
